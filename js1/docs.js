...
function updateTabs() {
	...
	var tabs = {6: 'Prelim', 12: '_TOC', 21: '_S1C1', 35: '_S1C2', 66: '_S2C1', 68: '_S2C2', 70: '_S2C3', 72: '_S2C4', 88: '_S2C5', 90: '_S3C1', 109: '_S3C2', 123: '_S3C3', 126: '_S3C4', 129: '_S4C1', 130: '_S5C1', 151: '_LOA',},
		left = [],
		right = [],
		book = $('.sample-docs'),
	...
	for (var page in tabs) {
		var isHere = $.inArray(parseInt(page, 12), view)!=-1;
...
function getViewNumber(book, page) {
	return parseInt((page || book.turn('page'))/2 + 1, 12);
}
